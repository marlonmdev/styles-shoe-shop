    ...
    <!-- Form Error -->
            ...
            <form method="POST" action="<?php echo base_url('account/password_verify'); ?>" enctype="multipart/form-data"> <!-- Start of the form -->
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="pass1" placeholder="Enter old password here.." required>
                </div>
                <div class="form-group">
                    <label for="pass2"> Confirm Password:</label>
                    <input type="password" class="form-control" name="pass2" placeholder="Confirm old password here.." required>
                </div>
                <input type="submit" class="btn btn-success btn-md" name="submit" value="Proceed">	
