...
<div class="container">
	<div class="row">
		...
		<ul class="nav nav-tabs">
		  ...
		  <li class="active"><a href="<?php echo base_url('Rebook'); ?>">Rebook</a></li>
	        ...
	        <div class="btn-group pull-right" style="margin-right:15px;">
	            ...
	            <div class="btn-group">
	                ...
	                <ul class="dropdown-menu">
	                    <li><a href="<?php echo base_url('Rebook/price_low'); ?>">By Price Low</a></li>
	                    <li class="divider"></li>
	                    <li><a href="<?php echo base_url('Rebook/price_high'); ?>">By Price High</a></li>
	                </ul>
	            </div>
	        </div>
	    </div>
	          ...
	          <a href="<?php echo base_url(); ?>show/item/<?php echo $item->id; ?>" style="text-decoration: none;">     
		            <div class="col-sm-4 col-md-2 col-xs-6">
		              <div class="thumbnail" id="itemPic" style="height:275px;">
		              	<img src="<?php echo base_url(); ?>images/brands/Rebook.png" id="logo" class="img-responsive pull-left" height="30" width="40" alt="rebook logo">
